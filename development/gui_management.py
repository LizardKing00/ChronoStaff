 ...
 # =============================================================================
    ...
    def create_theme_settings_section(self, parent):
        ...
        if THEMES_AVAILABLE:
            ...
            theme_combo.pack(side=tk.LEFT, padx=(10, 15))
            
            # Apply button # TODO: remove
            ...
            disabled_combo.pack(side=tk.LEFT, padx=(10, 15))
